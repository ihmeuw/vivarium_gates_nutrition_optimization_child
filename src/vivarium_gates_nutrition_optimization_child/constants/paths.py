...
WASTING_RELATIVE_RISKS = "/mnt/team/simulation_science/pub/models/vivarium_gates_nutrition_optimization_child/raw_data/wasting_rrs_with_subcategories_only_locations.csv"
PROBABILITIES_OF_WORSE_MAM_EXPOSURE = RAW_DATA_DIR / "worse_exp_frac_only_loc.csv"
UNDERWEIGHT_CONDITIONAL_DISTRIBUTIONS_DIR = "/mnt/team/simulation_science/pub/models/vivarium_gates_nutrition_optimization_child/raw_data/underweight_exp/"
CGF_PAFS = "/mnt/team/simulation_science/pub/models/vivarium_gates_nutrition_optimization_child/raw_data/cgf_pafs/"
