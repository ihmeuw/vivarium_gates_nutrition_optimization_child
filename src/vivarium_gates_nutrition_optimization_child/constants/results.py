...
WASTING_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{WASTING_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_MAM_TREATMENT_{MAM_TREATMENT}_MATERNAL_SUPPLEMENTATION_{SUPPLEMENTATION}_SAM_TREATMENT_{SAM_TREATMENT}_SEX_{SEX}"
