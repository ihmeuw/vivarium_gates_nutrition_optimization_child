...
DEATH_COLUMN_TEMPLATE = "MEASURE_death_due_to_{CAUSE_OF_DEATH}_SEX_{SEX}"
YLLS_COLUMN_TEMPLATE = "MEASURE_ylls_due_to_{CAUSE_OF_DEATH}_SEX_{SEX}"
YLDS_COLUMN_TEMPLATE = (
    "MEASURE_ylds_due_to_{CAUSE_OF_DISABILITY}_SEX_{SEX}"
)
...
STUNTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_stunting_{CGF_RISK_STATE_NUMERIC}_person_time_SEX_{SEX}_SQLNS_COVERAGE_{SQLNS_COVERAGE}"
...
WASTING_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{WASTING_TRANSITION}_event_count_SEX_{SEX}"
...
INCIDENT_WASTING_TRANSITIONS = ("mild_child_wasting_to_moderate_acute_malnutrition",
