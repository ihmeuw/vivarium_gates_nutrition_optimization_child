...
STUNTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_stunting_{CGF_RISK_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_SQLNS_COVERAGE_{SQLNS_COVERAGE}"
...
WASTING_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{WASTING_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_MAM_TREATMENT_{MAM_TREATMENT}_SAM_TREATMENT_{SAM_TREATMENT}"
