...
DEATH_COLUMN_TEMPLATE = "MEASURE_death_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
YLLS_COLUMN_TEMPLATE = "MEASURE_ylls_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_UNDERWEIGHT_STATE_{CGF_RISK_STATE}"
YLDS_COLUMN_TEMPLATE = "MEASURE_ylds_due_to_{CAUSE_OF_DISABILITY}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_UNDERWEIGHT_STATE_{CGF_RISK_STATE}"
DIARRHEA_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{DIARRHEA_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATE}"
LRI_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{LRI_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATE}"
MEASLES_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MEASLES_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATE}"
MALARIA_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MALARIA_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATE}"
...
DIARRHEA_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{DIARRHEA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATE}"
LRI_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{LRI_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATE}"
MEASLES_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MEASLES_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATE}"
MALARIA_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MALARIA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATE}"
...
WASTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_wasting_{CGF_RISK_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_BIRTH_WEIGHT_STATUS_{BIRTH_WEIGHT_STATUS}_SEX_{SEX}"
WASTING_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{WASTING_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_BIRTH_WEIGHT_STATUS_{BIRTH_WEIGHT_STATUS}_SEX_{SEX}"
...
TEMPLATE_FIELD_MAP = {
    ...
    "WASTING_TRANSITION": INCIDENT_WASTING_TRANSITIONS,
