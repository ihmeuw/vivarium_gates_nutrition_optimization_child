...
DEATH_COLUMN_TEMPLATE = "MEASURE_death_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
YLLS_COLUMN_TEMPLATE = "MEASURE_ylls_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
YLDS_COLUMN_TEMPLATE = "MEASURE_ylds_due_to_{CAUSE_OF_DISABILITY}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
DIARRHEA_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{DIARRHEA_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
LRI_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{LRI_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
MEASLES_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MEASLES_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
MALARIA_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MALARIA_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
MODERATE_PEM_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MODERATE_PEM_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
SEVERE_PEM_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{SEVERE_PEM_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
DIARRHEA_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{DIARRHEA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
LRI_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{LRI_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
MEASLES_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MEASLES_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
MALARIA_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MALARIA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"  # _WASTING_STATE_{WASTING_STATE}"
MODERATE_PEM_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MODERATE_PEM_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
SEVERE_PEM_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{SEVERE_PEM_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
STUNTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_stunting_{STUNTING_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SQLNS_COVERAGE_{SQLNS_COVERAGE}_SUBNATIONAL_{SUBNATIONAL}"
WASTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_wasting_{WASTING_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_MAM_TREATMENT_{MAM_TREATMENT}_SAM_TREATMENT_{SAM_TREATMENT}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
WASTING_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{WASTING_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_MAM_TREATMENT_{MAM_TREATMENT}_SAM_TREATMENT_{SAM_TREATMENT}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
UNDERWEIGHT_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_underweight_{UNDERWEIGHT_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
LOW_BIRTH_WEIGHT_SHORT_GESTATION_SUB_RISK_SUM_COLUM_TEMPLATE = "MEASURE_{LBWSG_SUB_RISK}_sum_BMI_ANEMIA_{BMI_ANEMIA}_MATERNAL_SUPPLEMENTATION_{SUPPLEMENTATION}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
LIVE_BIRTHS_COLUMN_TEMPLATE = "MEASURE_live_births_BMI_ANEMIA_{BMI_ANEMIA}_MATERNAL_SUPPLEMENTATION_{SUPPLEMENTATION}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
LOW_WEIGHT_BIRTHS_COLUMN_TEMPLATE = "MEASURE_low_weight_births_BMI_ANEMIA_{BMI_ANEMIA}_MATERNAL_SUPPLEMENTATION_{SUPPLEMENTATION}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
...
WASTING_STATES = tuple([category.value for category in data_keys.ChildWastingCategories])
WASTING_STATES_NUMERIC = ("cat1", "cat2", "cat2.5", "cat3", "cat4")
...
TEMPLATE_FIELD_MAP = {
    ...
    "STUNTING_STATE_NUMERIC": TETRACHOTOMTOUS_RISK_STATES,
    "WASTING_STATE_NUMERIC": WASTING_STATES_NUMERIC,
    "UNDERWEIGHT_STATE_NUMERIC": TETRACHOTOMTOUS_RISK_STATES,
