...
YLLS_COLUMN_TEMPLATE = "MEASURE_ylls_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
...
LRI_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{LRI_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
MEASLES_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{MEASLES_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
)
MODERATE_PEM_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MODERATE_PEM_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
SEVERE_PEM_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{SEVERE_PEM_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
DIARRHEA_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{DIARRHEA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
LRI_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{LRI_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
MEASLES_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{MEASLES_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
)
MODERATE_PEM_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MODERATE_PEM_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
SEVERE_PEM_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{SEVERE_PEM_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
STUNTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_stunting_{CGF_RISK_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_MATERNAL_SUPPLEMENTATION_{SUPPLEMENTATION}_SEX_{SEX}"
WASTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_wasting_{CGF_RISK_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_MATERNAL_SUPPLEMENTATION_{SUPPLEMENTATION}_SEX_{SEX}"
...
TEMPLATE_FIELD_MAP = {
    ...
    "MODERATE_PEM_TRANSITION": models.MODERATE_PEM.TRANSITIONS[:1],
    "SEVERE_PEM_TRANSITION": models.SEVERE_PEM.TRANSITIONS[:1],
