...
STUNTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_stunting_{STUNTING_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
...
TEMPLATE_FIELD_MAP = {
    ...
    "WASTING_STATE_NUMERIC": TETRACHOTOMTOUS_RISK_STATES,
