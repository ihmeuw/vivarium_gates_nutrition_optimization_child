...
DEATH_COLUMN_TEMPLATE = (
    "MEASURE_death_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
...
DIARRHEA_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{DIARRHEA_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
LRI_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{LRI_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
MEASLES_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{MEASLES_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
MALARIA_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{MALARIA_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
...
DIARRHEA_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{DIARRHEA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
LRI_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{LRI_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
MEASLES_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{MEASLES_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
MALARIA_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{MALARIA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_CHILD_WASTING_{CGF_RISK_STATE_NUMERIC}"
)
