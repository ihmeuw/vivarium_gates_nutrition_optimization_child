...
YLDS_COLUMN_TEMPLATE = (
    "MEASURE_ylds_due_to_{CAUSE_OF_DISABILITY}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
)
...
MODERATE_PEM_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{MODERATE_PEM_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
)
SEVERE_PEM_STATE_PERSON_TIME_COLUMN_TEMPLATE = (
    "MEASURE_{SEVERE_PEM_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
)
...
MODERATE_PEM_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{MODERATE_PEM_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
)
SEVERE_PEM_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{SEVERE_PEM_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SUBNATIONAL_{SUBNATIONAL}"
)
