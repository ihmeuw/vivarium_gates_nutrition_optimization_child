...
DEATH_COLUMN_TEMPLATE = (
    "MEASURE_death_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_WASTING_STATE_{CGF_RISK_STATES}"
)
...
WASTING_TRANSITION_COUNT_COLUMN_TEMPLATE = (
    "MEASURE_{WASTING_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_MAM_TREATMENT_{MAM_TREATMENT}_SAM_TREATMENT_{SAM_TREATMENT}_SEX_{SEX}"
)
