...
WASTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_wasting_{CGF_RISK_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_MAM_TREATMENT_{MAM_TREATMENT}_MATERNAL_SUPPLEMENTATION_{SUPPLEMENTATION}_SAM_TREATMENT_{SAM_TREATMENT}_SEX_{SEX}"
WASTING_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_child_wasting_{CGF_RISK_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_MAM_TREATMENT_{MAM_TREATMENT}_MATERNAL_SUPPLEMENTATION_{SUPPLEMENTATION}_SAM_TREATMENT_{SAM_TREATMENT}_SEX_{SEX}"
