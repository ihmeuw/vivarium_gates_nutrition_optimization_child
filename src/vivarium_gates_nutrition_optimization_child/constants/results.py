...
DEATH_COLUMN_TEMPLATE = "MEASURE_death_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
YLLS_COLUMN_TEMPLATE = "MEASURE_ylls_due_to_{CAUSE_OF_DEATH}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
YLDS_COLUMN_TEMPLATE = (
    "MEASURE_ylds_due_to_{CAUSE_OF_DISABILITY}_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
)
DIARRHEA_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{DIARRHEA_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
LRI_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{LRI_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
MEASLES_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MEASLES_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
MALARIA_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_{MALARIA_STATE}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
...
DIARRHEA_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{DIARRHEA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
LRI_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{LRI_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
MEASLES_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MEASLES_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
MALARIA_TRANSITION_COUNT_COLUMN_TEMPLATE = "MEASURE_{MALARIA_TRANSITION}_event_count_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"  # _WASTING_STATE_{WASTING_STATE}"
...
STUNTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_stunting_{STUNTING_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}_SQLNS_COVERAGE_{SQLNS_COVERAGE}"
WASTING_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_wasting_{WASTING_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_MAM_TREATMENT_{MAM_TREATMENT}_SAM_TREATMENT_{SAM_TREATMENT}_SEX_{SEX}"
...
UNDERWEIGHT_STATE_PERSON_TIME_COLUMN_TEMPLATE = "MEASURE_child_underweight_{UNDERWEIGHT_STATE_NUMERIC}_person_time_AGE_GROUP_{AGE_GROUP}_SEX_{SEX}"
